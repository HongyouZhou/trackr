...
run_experiment() {
    ...
    CMD="CUDA_VISIBLE_DEVICES=$GPU python scripts/train_flow_matching_tracker.py \
        num_envs=5 \
        pipeline=gpu \
        ...
        pretrain.training.model_save_freq=100 \
        pretrain.training.log_freq=500 \
        pretrain.training.model_save_dir=algo/pretrained/models \
